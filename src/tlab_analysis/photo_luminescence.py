...
class Data(abstract.AbstractData):
    ...
    def resolve_along_time(
        ...
        """
        Resolves data along the time axis.
    ...
    def resolve_along_wavelength(
        ...
        """
        Resolves data along the wavelength axis.
...
class TimeResolved:
    ...
    def smoothed_intensity(self, window: int = 3) -> pd.Series[t.Any]:
        """
        Returns a smoothed intensity by mean filtering.
...
class WavelengthResolved:
    ...
    def apply_offset(self) -> None:
        """
        Applies offset values to its dataframe.
    ...
    def unapply_offset(self) -> None:
        """
        Unapplies offset values to its dataframe.
    ...
    def fit(
        ...
        **kwargs: t.Any,
        ...
        """
        Fits a non-linear function to a intensity-time curve.
